...
int cariData(Kendaraan p[], int jumlah, string plat) {
    for (int i = 0; i < jumlah; i++)
        if (p[i].plat == plat) return i;   // ← perbaikan
    return -1;
}
...
int main() {
    ...
    do {
        ...
        cout << "1. tampilkan data kendaraan\n";
        cout << "2. Tampilkan semua data kendaraan\n";
        cout << "3. biaya parkir kendaran\n";
        ...
        case 1:
            if (jumlah < MAX) {
                ...
                cout << "jamMasuk  : "; cin >> parkir[jumlah].jamMasuk; // cout
                jumlah++;
            } else {
                cout << "parkiran penuh:\n";
            }
        ...
        case 2:
            for (int i = 0; i < jumlah; i++)
                cout << i+1 << ". " << parkir[i].plat << " | "
                     << parkir[i].jenis << " | "
                     << parkir[i].jamMasuk << endl;   // tambah endl
